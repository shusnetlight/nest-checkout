      ...
      {songs.map(song => {
        ...
        return (
          <button
            ...
            className={`flex sm:flex-col overflow-hidden rounded-xl border-2 cursor-pointer transition-all sm:w-40 w-full
              ${isSelected
                ? 'border-nl-purple-dark shadow-md'
                : 'border-nl-black/10 hover:border-nl-black/30'
              }`}
          >
            <div className="sm:w-full w-24 shrink-0 aspect-video overflow-hidden bg-nl-black/5">
              <img
            ...
            <div className="flex flex-col gap-0.5 px-3 py-2.5 bg-nl-white flex-1 justify-center">
